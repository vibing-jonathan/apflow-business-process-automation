        ...
        parts: [
          {
            text: [
              ...
              "Use discountAmount for invoice-level discounts, rebates, or markdowns as a positive number.",
              "Use adjustmentAmount for other invoice-level fees, credits, shipping, handling, rounding, or surcharges; positive increases the total and negative decreases it.",
              "Do not include the same discount in both discountAmount and adjustmentAmount.",
              "The expected total is subtotal + taxAmount - discountAmount + adjustmentAmount.",
